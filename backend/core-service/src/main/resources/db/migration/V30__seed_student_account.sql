...
DO $$BEGIN RAISE NOTICE 'Starting V22 Migration: Seeding Student Account...'; END$$;
...
BEGIN
    ...
    RAISE NOTICE '================================';
    RAISE NOTICE 'V22 Migration completed successfully!';
    RAISE NOTICE '================================';
