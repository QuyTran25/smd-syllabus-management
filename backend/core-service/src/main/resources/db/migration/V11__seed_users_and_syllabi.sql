...
INSERT INTO users (
    email, password, full_name, phone, gender, status, auth_provider
) VALUES 
-- ADMIN
...
SELECT
    ...
    CASE
        ...
        WHEN s.rn <= 12 THEN 'PENDING_HOD'::core_service.syllabus_status
    ...
    jsonb_build_object(
        ...
        'practice_hours', 45,
        'self_study_hours', 60,
        'objectives', 'Sinh viên nắm vững kiến thức nền tảng về ' || s.current_name_vi,
        'student_tasks', 'Bài tập tuần, Đồ án giữa kỳ, Bài thi cuối kỳ'
    ),
